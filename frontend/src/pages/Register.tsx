    ...
    <div className="min-h-screen bg-parchment flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-ink/10 p-8">
          ...
          <p className="text-sm text-ink/50 mb-6">Start studying smarter today</p>
          ...
          <p className="mt-6 text-center text-sm text-ink/50">
            ...
            <Link to="/login" className="font-medium text-moss hover:underline">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
